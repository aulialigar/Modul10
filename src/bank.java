...
JOptionPane.YES_NO_OPTION, 3); //konfirmasi transaksi lain
    ...
    JOptionPane.showMessageDialog(null,"Terimakasih telah menggunakan ATM BNI "
        + "SYARIAH - BOJONEGORO, ambil kartu ATM Anda.");
        System.exit(0);
...
JOptionPane.YES_NO_OPTION, 3); //konfirmasi transaksi lain
    ...
    JOptionPane.showMessageDialog(null,"Terimakasih telah menggunakan ATM BRI, "
        ...
        z=JOptionPane.showConfirmDialog(null,"Melanjutkan transaksi lain?","ATM "
        + "BNI SYARIAH-BOJONEGORO",
JOptionPane.YES_NO_OPTION, 3); //konfirmasi transaksi lain
...
if (z==0){
    ...
    JOptionPane.showMessageDialog(null,"Pin Salah !\nPastikan PIN yang anda "
        + "masukkan benar","ERROR",0);
    ...
    JOptionPane.showMessageDialog(null,"Untuk bantuan nasabah,\nsilahkan "
        + "menghubungi call center 555123 (Gratis)","Kartu ATM anda "
        + "diblokir!",0);
    System.exit(0);}
    }
